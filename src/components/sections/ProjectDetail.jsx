      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 2.5rem 5rem" }}>
        ...
        <div style={{ position: "relative", height: 260, overflow: "hidden", marginBottom: "2.5rem" }}>
          {project.coverImage ? (
            ...
            <div style={{ width: "100%", height: "100%", background: `linear-gradient(135deg, ${c}66 0%, ${c}22 60%, ${DARK} 100%)` }} />
          )}
          <div style={{
        ...
        {/* GitHub link - only shown when project has one */}
        {project.githubUrl && (
          <div style={{ marginBottom: "2rem" }}>
            <a
              ...
              style={{
                ...
                border: `1px solid ${c}44`, color: TEXT_PRIMARY,
                borderRadius: 8, fontFamily: PF, fontSize: 7,
                letterSpacing: "0.08em", textDecoration: "none",
                transition: "border-color 0.15s, transform 0.15s",
              }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = c; e.currentTarget.style.transform = "translateY(-1px)"; }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = `${c}44`; e.currentTarget.style.transform = "translateY(0)"; }}
            >
